...
function emit_junk(_x, _y){
	...
	part_type_sprite(_ptype1, sprSpaceJunkPart3, false, true, false)
	...
	part_type_colour3(_ptype1, $A08E80, $FFFFFF, $191919);
	...
	part_type_sprite(_ptype2, sprSpaceJunkPart2, false, true, false)
	...
	part_type_colour3(_ptype2, $FFD2B2, $FFFFFF, $191919);
	...
	part_type_sprite(_ptype3, sprSpaceJunkPart1, false, true, false)
	...
	part_type_colour3(_ptype3, $FFFCCC, $FFFFFF, $191919);
