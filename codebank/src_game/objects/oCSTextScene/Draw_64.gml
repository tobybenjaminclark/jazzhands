...
draw_text((display_get_gui_width() div 2), (display_get_gui_height() div 2) + 230, heading);
...
draw_text((display_get_gui_width() div 2), (display_get_gui_height() div 2) + 280, body_visible);